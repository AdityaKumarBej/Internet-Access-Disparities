# step 3: Add age attributes to mlab dataset (aleready has race and gender attributes)

import pandas as pd

# Load race.csv and mlab.csv
age_df = pd.read_csv("../../../datasets/CENSUS/US/Age_geoid.csv")
mlab_df = pd.read_csv("../../../results/mlab/US/Woodard_research/mlab_woodard_race_gender.csv")
...
df_merged = pd.merge(mlab_df, df_filtered, on='geoid', how='left')
...
df_merged.to_csv("../../../results/mlab/US/Woodard_research/mlab_woodard_race_gender_age.csv", index=False)
