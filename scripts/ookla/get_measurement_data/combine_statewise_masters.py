# Step 2: Combine all state CSV files (average_stats.csv of all 5 years) into a master CSV file --> now contains all the measurement data from the yearly masters from all states.
