...
df = pd.read_csv("../../../results/ookla/USA/Woodard_research/ookla_mobile_woodard_race_gender_age.csv")
...
df.to_csv("../../../results/ookla/USA/Woodard_research/ookla_mobile_woodard_race_gender_age_new.csv", index=False)