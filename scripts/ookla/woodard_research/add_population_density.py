...
input_csv = '../../../results/ookla/US/woodard_research/ookla_mobile_woodard_race_gender_age.csv'
census_file = '../../../datasets/census/US/regions/tl_2023_us_county.zip'

output_csv = '../../../results/ookla/US/woodard_research/ookla_mobile_woodard_race_gender_age_density.csv'
